...
# MiSeq-${miseq_run_number} % IgA+ Data Prep{.tabset}
## Clustering Level
...
## IgA Flow Count Cutoff
**IgA+ flow count cutoff:** ${flow_count_cutoff}
...
#     stringsAsFactors=F
#     ) %>%
#   filter(TotalFlowEvents > ${flow_count_cutoff})
...
```{r}
abundance = getFilteredTaxaCountsDev(
  asv_table,
  taxonomy_table,
  sample_data, 
