...
# MiSeq-`r miseq_run_number` `r analysis_type` Analysis: Raw Data Plots {.tabset}
...
```
**Raw Experimental Variables: ** `r raw_exp_variables`
...
makeBoxAndDotplot(
  ...
  title="Alpha Diversity---AMD Only"
)
```
