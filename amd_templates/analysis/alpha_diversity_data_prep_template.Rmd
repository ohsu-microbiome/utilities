...
# ${miseq_project_prefix} `r analysis_title` Data Prep {.tabset}
...
source('https://raw.githubusercontent.com/ohsu-microbiome/utilities/master/analysis-utilities/alpha_div_utilities.R')
...
all_alpha_diversity = calculateAlphaDiversity2(
  ...
  c('observed', 'shannon', 'simpson', 'invsimpson')
)
...
all_master_table =
  ...
  select(SampleName, Observed=observed, Shannon=shannon, Simpson=simpson, InvSimpson=invsimpson, sample_data_columns, everything())
